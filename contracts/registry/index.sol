...
contract InstaIndex is CloneFactory {
    ...
    function build(
        address _owner,
        uint256 accountVersion, // 2
        address _origin // 0x0000000000000000000000000000000000000000
        ...
        ListInterface(list).init(_account); // add account address to the list and give id number
